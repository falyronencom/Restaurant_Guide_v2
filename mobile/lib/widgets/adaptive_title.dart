...
/// 2. **Пересчитывать, когда сменился шрифт.** Вшитые семейства объявлены в
///    pubspec и доступны с первого кадра, но шрифт может прийти и позже —
///    через `FontLoader` в рантайме или сменой системных шрифтов. Абзац после
///    этого перекладывается сам, а решение о кегле — нет, если его не
///    пересчитать. (До 23.09.2026 шрифты поднимал пакет google_fonts —
///    асинхронно, при первом использовании, — и первый замер приходился на
///    подстановочный шрифт; так правило и появилось.)
