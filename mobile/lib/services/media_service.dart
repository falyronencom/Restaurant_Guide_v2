...
class MediaService {
  ...
  /// Upload a PDF menu file for partner registration
  ///
  /// [filePath] - Local file path of the PDF
  /// [onProgress] - Optional callback for upload progress (0.0 to 1.0)
  ///
  /// Returns [UploadedMedia] with url/thumbnail/preview URLs generated by
  /// Cloudinary's pg_1 transformation on the PDF's first page. Throws on
  /// failure; caller surfaces the message via snackbar.
  Future<UploadedMedia> uploadPdf({
    required String filePath,
    void Function(double progress)? onProgress,
  }) async {
    final file = File(filePath);
    ...
    try {
      ...
      String message = 'Failed to upload PDF';
