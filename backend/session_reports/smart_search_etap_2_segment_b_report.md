...
- Миграция 025 применена локально (pg-test) и на Railway production 23 апреля 2026
- Миграция 024 применена на Railway 23 апреля 2026 (ранее была только локально)
