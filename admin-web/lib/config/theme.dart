...
class AppTheme {
  ...
  ///
  /// JetBrains Mono в каноне помечен как предложенный и пока НЕ вшит: файла нет
  /// ни в mobile/google_fonts/, ни здесь. До тех пор срабатывает системный
  /// фаллбэк ниже. Когда .ttf положат в admin-web/google_fonts/, шрифт
  /// подхватится без правок в коде — имя семейства уже указано первым.
  ...
  /// Заголовок экрана в хедере 72px: Unbounded 25/w400 чёрный.
