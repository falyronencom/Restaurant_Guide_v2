...
/// State management for the Establishments analytics tab
class EstablishmentsAnalyticsProvider with ChangeNotifier {
  final AnalyticsService _service;

  EstablishmentsAnalyticsData? _data;
  ...
  EstablishmentsAnalyticsData? get data => _data;
  ...
  Future<void> load({String? period, String? from, String? to}) async {
    ...
    try {
      _data = await _service.getEstablishmentsAnalytics(
        period: _period,
        from: _customFrom,
        to: _customTo,
      );
