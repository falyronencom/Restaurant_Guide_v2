...
/// State management for the Reviews analytics tab
class ReviewsAnalyticsProvider with ChangeNotifier {
  final AnalyticsService _service;

  ReviewsAnalyticsData? _data;
  ...
  ReviewsAnalyticsData? get data => _data;
  ...
  Future<void> load({String? period, String? from, String? to}) async {
    ...
    try {
      _data = await _service.getReviewsAnalytics(
        period: _period,
        from: _customFrom,
        to: _customTo,
      );
